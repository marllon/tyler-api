...
class GoalServiceImpl(
    ...
    override fun addAmount(id: String, amount: Double): GoalResponse? {
        ...
        val updates =
                mutableMapOf<String, Any>("currentAmount" to newCurrentAmount, "updatedAt" to now)
    ...
    override fun uploadImage(id: String, file: MultipartFile): String? {
        ...
        val goal =
                goalRepository.findById(id) ?: throw IllegalArgumentException("Goal not found: $id")
