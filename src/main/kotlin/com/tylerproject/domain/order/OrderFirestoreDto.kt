...
/**
 * DTOs para Firestore - DEVEM ter construtor no-argument e propriedades mutáveis
 * Firestore usa reflexão e precisa disso para desserialização
 */
...
/**
 * DTO para salvar/ler Order do Firestore
 * Usa propriedades mutáveis (var) e tem construtor no-arg
 */
