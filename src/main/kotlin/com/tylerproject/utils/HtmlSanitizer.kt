 ...
 * 
 * Permite tags HTML seguras, quebras de linha, imagens inline (base64 ou URLs),
 * mas remove scripts, iframes e outros elementos perigosos.
 */
@Component
class HtmlSanitizer {
    ...
    private fun sanitizeAllowedTags(html: String): String {
        ...
        result = tagPattern.replace(result) { matchResult ->
    ...
    private fun validateBase64Images(html: String): String {
        ...
        return base64Pattern.replace(html) { matchResult ->
            ...
            if (estimatedSize > MAX_BASE64_IMAGE_SIZE) {
                logger.warn("Base64 image too large: $estimatedSize bytes (max: $MAX_BASE64_IMAGE_SIZE)")
